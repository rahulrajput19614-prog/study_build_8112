...
import '../presentation/exam_category_dashboard/exam_category_dashboard.dart'; // Corrected import to match the file name
...
class AppRoutes {
  ...
  static Map<String, WidgetBuilder> routes = {
    ...
    examCategoryDashboard: (context) => const ExamCategoryDashboard(), // Corrected class name
