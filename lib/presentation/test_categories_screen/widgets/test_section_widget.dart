...
class _TestSectionWidgetState extends State<TestSectionWidget> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: Colors.black.withOpacity(0.05), // ✅ withValues को withOpacity से बदला गया
            blurRadius: 8,
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: AppTheme.lightTheme.colorScheme.primary
                              .withOpacity(0.1), // ✅ withValues को withOpacity से बदला गया
                          borderRadius: BorderRadius.circular(12),
                        ),
                        child: Text(
                  ...
                  if (isPremium)
                    Container(
                      padding: EdgeInsets.symmetric(
                          horizontal: 2.w, vertical: 0.5.h),
                      decoration: BoxDecoration(
                        color: Colors.amber.withOpacity(0.2), // ✅ withValues को withOpacity से बदला गया
                  ...
                  _buildInfoChip(
                    CustomIconWidget(
                      ...
                      color: AppTheme.lightTheme.colorScheme.onSurface
                          .withOpacity(0.6), // ✅ withValues को withOpacity से बदला गया
                      size: 14,
                    ),
                    '${test['duration']} min',
                  ),
    ...
    return Row(
      ...
      children: [
        ...
        Text(
          ...
          style: AppTheme.lightTheme.textTheme.bodySmall?.copyWith(
            color: AppTheme.lightTheme.colorScheme.onSurface
                .withOpacity(0.7), // ✅ withValues को withOpacity से बदला गया
          ),
        ),
      ],
    );
  ...
  Widget _buildDifficultyChip(String difficulty) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: chipColor.withOpacity(0.1), // ✅ withValues को withOpacity से बदला गया
        borderRadius: BorderRadius.circular(4),
      ),
      child: Text(
        difficulty,
